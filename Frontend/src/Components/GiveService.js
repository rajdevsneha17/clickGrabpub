...
//     try {
//       const res = await axios.post("http://localhost:7005/api/v1/giveservice", data);
...
//   //       setValue("imagefile", base64String); // Set the value in the form as base64 string
//   //     };
...
//   return (
//     <div>
//       <div className="container mx-auto -mt-[38rem] p-4 h-sreen w-full">
